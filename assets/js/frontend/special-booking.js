...
(function() {
    ...
    class SpecialBooking {
        ...
        redirectToBookingPage(bookingPageUrl, arrivalISO, departureISO) {
            ...
            try {
                ...
                if (discountInput && discountInput.value) {
                    url.searchParams.set('DiscountCode', discountInput.value);
                }
            } catch (e) { /* ignore */ }
        ...
        redirectToBookingEngine(arrivalISO, departureISO) {
            ...
            let engineUrl = bookingEngineBaseUrl + encodeURIComponent(this.hotelId) + '/Rooms/Select?';
            const params = [];
            ...
            try {
                const discountInput = document.querySelector('.mlb-calendar-modal-overlay .mlb-discount-code');
                if (discountInput && discountInput.value) {
                    params.push('DiscountCode=' + encodeURIComponent(discountInput.value));
                }
            } catch (e) { /* ignore */ }
