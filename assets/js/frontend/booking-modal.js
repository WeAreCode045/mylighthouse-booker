        ...
        if (pName === 'rate') {
            ...
            try {
                ...
                if (discountInput && discountInput.value) {
                    qs.set('DiscountCode', discountInput.value);
                }
            } catch (e) { /* ignore */ }

            const hotelPath = hotelId ? encodeURIComponent(hotelId) + '/Rooms/Select' : 'Rooms/Select';
            ...
            try {
                const discountInput = document.querySelector('.mlb-calendar-modal-overlay .mlb-discount-code');
                if (discountInput && discountInput.value) {
                    iframeSrc += '&DiscountCode=' + encodeURIComponent(discountInput.value);
                }
            } catch (e) { /* ignore */ }
        }
