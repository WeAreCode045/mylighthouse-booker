...
(function() {
    ...
    iframe.setAttribute('title', mlbGettext('Booking results'));
        ...
        let iframeSrc = bookingEngineBaseUrl + encodeURIComponent(hotelId) + '/Rooms/Select?Arrival=' + encodeURIComponent(arrivalISO) + '&Departure=' + encodeURIComponent(departureISO);

        // paramName can be 'room' or 'rate' (special). Default to 'room' for backward compatibility
