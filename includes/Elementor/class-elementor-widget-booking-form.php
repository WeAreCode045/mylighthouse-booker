...
class Mylighthouse_Booker_Elementor_Widget_Booking_Form extends Widget_Base
{
	...
	protected function render()
	{
		...
		if ($form_type === 'special') {
			...
			// Enqueue room booking script (used for opening modal and redirect logic)
			// Enqueue special booking script (used for opening modal and redirect logic)
			if (!wp_script_is('mylighthouse-booker-special-booking', 'enqueued')) {
		...
		// For room forms, hide the date picker field (will open modal on button click)
		$show_date_picker = ($form_type !== 'room');
