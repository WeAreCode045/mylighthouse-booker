...
<div class="mlb-section-card">
    ...
    <table class="form-table">
        <tr>
            ...
            <td><input type="text" id="hotel_name" name="hotel_name" value="<?php echo esc_attr($name); ?>" class="regular-text" required /></td>
        </tr>
        <tr>
            <th><label for="hotel_external_id"><?php esc_html_e('External ID','mylighthouse-booker'); ?></label></th>
            <td><input type="text" id="hotel_external_id" name="hotel_external_id" value="<?php echo esc_attr($external_id); ?>" class="regular-text" required /></td>
        </tr>
    </table>
</div>
