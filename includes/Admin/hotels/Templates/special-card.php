...
<div class="mlb-list-item mlb-repeater-item mlb-special-card" data-index="<?php echo esc_attr($index); ?>">
    ...
    <div class="mlb-item-actions">
        <button type="button" class="mlb-edit-special-btn mlb-btn mlb-btn-primary mlb-btn-sm" title="<?php esc_attr_e('Edit special', 'mylighthouse-booker'); ?>">
            <span class="dashicons dashicons-edit" aria-hidden="true"></span>
        </button>
        <button type="button" class="mlb-remove-special-btn mlb-remove-hotel mlb-btn mlb-btn-danger mlb-btn-sm" title="<?php esc_attr_e('Delete special', 'mylighthouse-booker'); ?>" aria-label="<?php esc_attr_e('Delete special', 'mylighthouse-booker'); ?>">
